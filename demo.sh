...
curl -i -H 'Accept: application/vnd.messages-v2+json' -d "title='message 2'&content='content 2'" http://localhost:8080/message
echo

echo
echo "Getting first page of messages using service v2.0"
curl -i -G -H 'Accept: application/vnd.messages-v2+json' -H 'Content-type: application/json'  http://localhost:8080/messages/1
echo

echo
echo "Getting second page of messages using service v2.0"
curl -i -G -H 'Accept: application/vnd.messages-v2+json' -H 'Content-type: application/json'  http://localhost:8080/messages/2
echo
